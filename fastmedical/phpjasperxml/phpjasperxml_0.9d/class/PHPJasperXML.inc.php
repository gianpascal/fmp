...
class PHPJasperXML
{
    ...
    public function load_xml_string($jrxml)
    {
        ...
        //echo "wwww"+$this->xml_dismantle($xml);
    }
    ...
    public function load_xml_file($file)
    {
        ...
        //var_dump($this->load_xml_string($xml));exit();
    }

    public function xml_dismantle($xml)
    {
        try {
            //var_dump('<pre>',$xml);exit();
    ...
    public function element_image($data)
    {
        ...
        if ($imagepath != null || strlen(trim($imagepath))) {
...
echo "<br>";*/
    ...
    public function transferDBtoArray($host, $user, $password, $db_or_dsn_name, $cndriver = "mysql")
    {
        ...
        //var_dump('<pre>',$this->arraysqltable);exit();
            ...
            foreach ($this->arraytitle as $out) {
                switch ($out["hidden_type"]) {
                    ...
                    case "break":
                        ...
                        break;
                    default:
                        //var_dump("3914 Aqui muere (PHPJasperXML.inc.php)");
    ...
    public function display($arraydata, $y_axis = 0, $fielddata = false, $maxheight = 0)
    {
        ...
        if ($arraydata["type"] == "SetFont") {
            ...
            $path = $arraydata["path"]; //$this->analyse_expression($arraydata["path"]);
            //echo $path . "<br>";
            if ($path != null) {
                ...
                $imgtype2 = substr($path, (strrpos($path, '.') + 1));
                if (strcasecmp($imgtype, 'jpg') == 0 || strcasecmp($imgtype2, 'jpg') == 0 || strcasecmp($imgtype2, 'jpeg') == 0) {
                    $imgtype = "JPEG";
                } elseif (strcasecmp($imgtype, 'png') == 0) {
    ...
    public function passAllArrayDatatoSubReport($PHPJasperXMLSubReport, $d, $current_y, $data)
    {
        ...
        if (isset($this->arraypageHeader)) {
            ...
            if ($this->currentband == 'pageHeader') {
                ///here need to add more conditions to fulfill different band subreport
