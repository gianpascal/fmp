...
class generarMYPDFRME {

    function generarMYPDF_RME($atributosReceta, $labelCabecera, $labelPie, $datosCabecera, $datosDetalle, $datosPie, $modo, $nombreReporte, $parametros) {
...
//        $styleDD=array();
        ...
        $cadenaAntecedentes = $RP . '<table width="700" border="1" cellpadding="3" cellspacing="0" bgcolor="#ffffff">
                                <tr>
                                    <td rowspan="2" width="35" align="center"><strong><BR>NRO</strong></td>
                                    <td rowspan="2" align="center" width="255"><strong><BR>MEDICAMENTO O INSUMO</strong><br/>
                                    <strong>( OBLIGATORIO DCI )    /   CONCENTRACION</strong></td>
                                    <td rowspan="2" align="center" width="80"><strong><BR>FORMA FARMACEUTICA</strong></td>
                                    <td rowspan="2" align="center" width="75"><strong><BR>CANTIDAD</strong></td>
                                    <td colspan="4" align="center" width="260"><strong><BR>INDICACIONES</strong></td>
                                    </tr>
                                    <tr>
        ...
        foreach ($datosDetalle as $key => $value) {
            ...
            $cadenaAntecedentes.='<tr>
                                    ...
                                    <td colspan="4">';
            if (strpos($value[4], '|')) {
                $cadenaModo=(explode('|',$value[4]));
                 $cadenaAntecedentes.= $cadenaModo[2] ;
            }else {
                $cadenaAntecedentes.= utf8_encode($value[4]);
            }
            $cadenaAntecedentes.='</td>
                                  </tr>';
        }
        $cadenaAntecedentes.='</table><br>';
