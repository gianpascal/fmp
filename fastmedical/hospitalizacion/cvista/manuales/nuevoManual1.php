    ...
    <table width="100" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td width="33%">
                ...
                $toolbar1->SetBoton("GRABAR","Grabar","btn","onclick,onkeypress","nue_actManual('nuevo')",$_SESSION['path_principal']."../medifacil_front/imagen/icono/grabar.png");
                $toolbar1->Mostrar();
                ?>
            </td>
            <td width="33%">
                ...
                $toolbar2->SetBoton("ACTUALIZAR","Actualizar","btn","onclick,onkeypress","nue_actManual('actualizar')",$_SESSION['path_principal']."../medifacil_front/imagen/icono/reload3.png");
                $toolbar2->Mostrar();
                ?>
            </td>
            <td width="33%">
                ...
                $toolbar3->SetBoton("ELIMINAR","Eliminar","btn","onclick,onkeypress","eliminaManual()",$_SESSION['path_principal']."../medifacil_front/imagen/icono/delete.png");
                $toolbar3->Mostrar();
                ?>
            </td>
        </tr>
