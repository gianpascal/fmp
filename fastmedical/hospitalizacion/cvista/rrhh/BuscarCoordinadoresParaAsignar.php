...
<!--                <div style="width: 100%; height: 25%;">
                ...
                <div style="width: 100%; height: 25%;">
                    ...
                    <div style="width: 30%; float: left;" id="DivtextApePat">
                        <input type="text" size="12" value="" onkeypress="if(event.keyCode==13)buscarCoordinadoresPopap(document.getElementById('apellidoPaterno').value,document.getElementById('apellidoMaterno').value,document.getElementById('nombres').value)" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="apellidoPaterno" name="textfield3"/>
<!--                     <input type="text" size="12" value="" onkeypress="limpiaBusquedasPopap('10',this,event);" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="apellidoPaterno" name="textfield3"/>
                   -->
                    ...
                    <div style="width: 30%; float: left;" id="DivTextapeMat">
                        <input type="text" size="12" value="" onkeypress="if(event.keyCode==13)buscarCoordinadoresPopap(document.getElementById('apellidoPaterno').value,document.getElementById('apellidoMaterno').value,document.getElementById('nombres').value)" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="apellidoMaterno" name="textfield4"/>
                    </div>
                </div>
                ...
                <div style="width: 100%; height: 25%;">
                    ...
                    <div style="width: 30%; float: left;" id="DivtextNombre">
                        <input type="text" size="12" value="" onkeypress="if(event.keyCode==13)buscarCoordinadoresPopap(document.getElementById('apellidoPaterno').value,document.getElementById('apellidoMaterno').value,document.getElementById('nombres').value)" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="nombres" name="textfield5"/>
                    </div>
...
<!--        750-->
        <div id="divResultadoCoordinadores" style="width: 400px; height: 250px;" align="center">
