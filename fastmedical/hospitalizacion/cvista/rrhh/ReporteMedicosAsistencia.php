                                ...
                                <tr>
                                    <td align="center" colspan="4">
                                        ...
                                        if (isset($_SESSION["permiso_formulario_servicio"][224]["BUSCAR_REGISTRO_ASISTENCIA_EMP"]) && ($_SESSION["permiso_formulario_servicio"][224]["BUSCAR_REGISTRO_ASISTENCIA_EMP"] == 1)) {
                                            echo '<a href="javascript:reporteBusquedaMedico();"><img border="0" title="Codigo de Persona" alt="" src="../../../../medifacil_front/imagen/btn/nbtn_buscar.gif"/></a>';
                                        }
                                        ?>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div style="width: 100px;" align="center">
                                            ...
                                            if (isset($_SESSION["permiso_formulario_servicio"][224]["BUSCAR_EMP_POPPAD"]) && ($_SESSION["permiso_formulario_servicio"][224]["BUSCAR_EMP_POPPAD"] == 1)) {
                                                $toolbar1->SetBoton("BusquedaEmpleado", "Buscar Empleado", "btn", "onclick,onkeypress", "podpadBusquedaMedicos()", $_SESSION['path_principal'] . "../medifacil_front/imagen/icono/kopeteavailable.png", "", "", 1);
                                                $toolbar1->Mostrar();
                                            }
                                            ?>
                                        </div>
