...
<div  id ="divPublicaciones" style="width:99%;height:inherit;margin-left:1%;margin-right:1%;overflow:scroll; ">
 <fieldset style="margin:1px;width:98%;height:22px;padding: 0px;">
    ...
    <div  id ="divDatosPublicaciones" style="width:99%;height:300px;margin-left:1%;margin-right:1%; ">

    </div>
    <div  id ="divBotonesPublicaciones" style="width:99%;height:inherit;margin-left:1%;margin-right:1%; " align="center">
   ...
   <div  id ="divResultadoPublicaciones" style="width:99%;height:235px;margin-left:1%;margin-right:1%; ">
