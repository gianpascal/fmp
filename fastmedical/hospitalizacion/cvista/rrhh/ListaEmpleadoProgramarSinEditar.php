                            ...
                            <table id="tblProgramacionPersonal<?php echo $i ?>" border="1"  style="width: 1200px ; height: 10px ; font-family:  Arial; font-size: 12px;font-weight: bold " cellspacing="1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 80px">Nombre Empleados</th>
                                        ...
                                        <th style="width: 38px" <?php if ($value[5] == 0) echo ' hidden'; ?>>Acc</th>
                                        <?php
...
//===========================================================================================================================
                                                foreach ($valuex[13] as $k => $valuey) { //Turnos --------------------------------------------------
                                                    if (trim($valuey[3]) != '1') {//dias programados
                                                        if ($value[5] == 1) {// Permiso para modificar
                                                            if ($valuey[15] == "D") { // si es Domingo lo pinto
                                                                ...
                                                                <?php } else { ?>
                                                                    <td style="width: 22px; height: 20px" bgcolor="#E88D8D"> <!-- domingo  sin vacaciones-->
                                                                        <a href="javascript:programacionPorDiaConTurno(<?php echo $i ?>,<?php echo $a ?>,<?php echo $k ?>)" >
                                                                            <font color="<?php echo $valuey[7] ?>" size="2" title="<?php echo $arrayDiaDelmes[$k][1].'--'.$arrayDiaDelmes[$k][0].'('.$valuey[11].')' ?>"><?php echo $valuey[3] ?></font></a>
                                                                ...
                                                                if ($valuey[8] == "2") { //vacaciones
                                                                    ?>
                                                                    <td style="width: 22px; height: 20px" bgcolor="<?php echo $valuey[9] ?>">
                                                                        <font color="blue" size="2">V</font>
                                                                    </td>
                                                                <?php } else { ?>
                                                                    <td style="width: 22px; height: 20px" bgcolor="<?php echo $valuey[7] ?>"> <!-- cambiar Color a la Sede -->
                                                                        <a href="javascript:programacionPorDiaConTurno(<?php echo $i ?>,<?php echo $a ?>,<?php echo $k ?>);" >
                                                                            <font title="<?php echo $arrayDiaDelmes[$k][1].'--'.$arrayDiaDelmes[$k][0].'('.$valuey[11].')' ?>"  size="2"><?php echo $valuey[3] ?></font></a>
                                                                        <input id="hICodTurnoAreaSede<?php echo $i ?><?php echo $a ?><?php echo $k ?>" type="hidden"
                                                                               value="<?php echo $valuey[4] ?>" />
                                                                        <input id="hiCodProgramacionEmpleado<?php echo $i ?><?php echo $a ?><?php echo $k ?>" type="hidden"
                                                                               value="<?php echo $valuey[1] ?>" />
                                                            ...
                                                            //  ======================================================================================================0
                                                        } else {// Sin Permiso para modificar
                                                            if ($valuey[15] == "D") { // si es Domingo lo pinto
                                                                if ($valuey[8] == "2") {
                                                                    ?>
                                                                    <td style="width: 22px; height: 20px" bgcolor="#E88D8D"> <!-- domingo vacaciones-->
                                                                ...
                                                                <?php } else { ?>
                                                                    <td style="width: 22px; height: 20px" bgcolor="#E88D8D"> <!-- domingo  sin vacaciones-->
                                                                        ...
                                                                        <font color="<?php echo $valuey[7] ?>" size="2" title="<?php echo $arrayDiaDelmes[$k][1].'--'.$arrayDiaDelmes[$k][0].'('.$valuey[11].')' ?>"><?php echo $valuey[3] ?></font>
                                                                        <input id="hICodTurnoAreaSede<?php echo $i ?><?php echo $a ?><?php echo $k ?>" type="hidden"
                                                                               value="<?php echo $valuey[4] ?>" />
                                                                    </td>
                                                                ...
                                                                if ($valuey[8] == "2") { //vacaciones
                                                                    ?>
                                                                    <td style="width: 22px; height: 20px ; background-color: #E88D8D;">
                                                                        <font color="blue" size="2">V</font>
                                                                    </td>
                                                                <?php } else { ?>
                                                                    <td style="width: 22px; height: 20px; background-color: #C0C0C0;"> <!-- cambiar Color a la Sede -->
...
// ========================================================================================================================================
                                                        ...
                                                        if ($valuey[15] == "D") {// cuando es domingo sin  programacion
                                                            if ($value[5] == 1) {
                                                                ...
                                                                <?php if ($valuey[8] == 2 || $valuey[8] == 2) { ?>
                                                                    <td style="width: 22px; height: 20px" bgcolor="<?php echo $valuey[9] ?>"> <!-- domingo vacaciones-->
                                                                        <font color="<?php echo $valuey[7] ?>" title="<?php echo $arrayDiaDelmes[$k][1].'--'.$arrayDiaDelmes[$k][0] ?>" size="2"><?php echo $valuey[10] ?></font>
                                                                    </td>
                                                                <?php } else { ?>
