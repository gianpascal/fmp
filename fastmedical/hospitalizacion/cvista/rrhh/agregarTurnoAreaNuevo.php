                ...
                <table>
                    ...
                    if (1==1) {
                        echo "<tr align=center>
                                <td align=center>
                                    <a href=\"javascript:javascript:asignarTurnoDisponibleAlAreaNuevo();\"><img  id=\"imgagenGuardar\" src=\"../../../../fastmedical_front/imagen/icono/b_adelante.gif\" width=25px height=25px/></a>
                                  </td>
                                  </tr>
                                    ";
                    } else {
                    ...
                    if (1==1) {
                        echo "<tr align=center>
                                <td align=center>
                                    <a href=\"javascript:javascript:quitarTurnoSeleccionadoAlAreaNuevo();\"><img  id=\"imgagenGuardar\" src=\"../../../../fastmedical_front/imagen/icono/b_atras.gif\" width=25px height=25px/></a>
                                  </td>
                                  </tr>
                                    ";
                    } else {
