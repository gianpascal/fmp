                        ...
                        <div style="width: 200px; height: 30px; ">
                            ...
                            <div  id ="divEtiquetaBuscar" style="width:100px;  float:left;" align="center">
                                ...
                                if (isset($_SESSION["permiso_formulario_servicio"][224]["BUSCAR_EMP"]) && ($_SESSION["permiso_formulario_servicio"][224]["BUSCAR_EMP"] == 1)) {
                                    echo '<a href="javascript:buscarEmpleadosX(document.getElementById(\'txtCodigo\').value,document.getElementById(\'comboTipoEstados\').value,document.getElementById(\'comboTipoDocumentos\').value,document.getElementById(\'nroDoc\').value,document.getElementById(\'apellidoPaterno\').value,document.getElementById(\'apellidoMaterno\').value,document.getElementById(\'nombres\').value);"><img id="imgbusqueda" border="0" title="Codigo de Persona" alt="" src="../../../../medifacil_front/imagen/btn/nbtn_buscar.gif"/></a>';
                                }
                                ?>
                            </div>
                            <div  id ="divEtiquetaLimpiar" style="width:100px;  float:left;" align="center">
                                ...
                                if (isset($_SESSION["permiso_formulario_servicio"][224]["LIMPIAR_EMP"]) && ($_SESSION["permiso_formulario_servicio"][224]["LIMPIAR_EMP"] == 1)) {
                                    echo '<a href="javascript:limpiaBusquedasX(\'0\',\'\',\'\');"><img border="0" title="Limpia" alt="" src="../../../../medifacil_front/imagen/btn/btn_limpiar.gif"/></a>';
                                }
                                ?>
                            </div> 
                        </div>
