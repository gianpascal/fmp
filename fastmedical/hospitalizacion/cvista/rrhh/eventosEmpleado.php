...
<div  id ="divExperiencia" style="width:99%;height:inherit;margin-left:1%;margin-right:1%;overflow:scroll; ">
 <fieldset style="margin:1px;width:98%;height:22px;padding: 0px;">
    ...
    <div  id ="divDatosEventos" style="width:99%;height:190px;margin-left:1%;margin-right:1%; ">
   ...
   <div  id ="divResultadoEventos" style="width:99%;height:260px;margin-left:1%;margin-right:1%; ">
