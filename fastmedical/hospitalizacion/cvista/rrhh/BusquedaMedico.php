<html>
    ...
    <body>
        ...
        <div id="divBusquedaPersonas" style="width:550px; float: left" > 
                    ...
                    <form>
                        <div style="width: 100%; height: 30px; ">
                            ...
                            <div style="float: left;" id="DivTextCodigo">
                                <input type="text" style="width:120px;" value="Buscar..." onkeypress="limpiaBusquedasXMedico('01',this,event);return validFormSalt('nro', this, event, 'imgbusqueda');" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" maxlength="7" id="txtCodigo" name="txtCodigo"/>
                            </div>
                        </div>
                        <div style="width: 100%; height: 30px; ">
                            ...
                            <div style=" float: left;" id="DivSelectEstado">
                                <select  style="width: 120px; font-size: 9px;" id="comboTipoEstados" name="selectE">
                                    ...
                                    <option selected="selected" value="1" onclick="limpiaBusquedasXMedico('02',this,'1');">Activos</option>
                                    <option value="0" onclick="limpiaBusquedasXMedico('02',this,'1');">Inactivos</option>
                                </select>
                            </div>
                        </div>
                        <div style="width: 100%; height: 30px; ">
                        ...
                        <div style="width: 100%; height: 30px; ">
                            ...
                            <div style="float: left;" id="DivTextDoc">
                                <input type="text" style="width:120px;" value="Buscar..."
                                       onkeypress="limpiaBusquedasXMedico('03',this,event);"
                        ...
                        <div style="width: 100%; height: 30px; ">
                            ...
                            <div style="float: left;" id="DivtextApePat">
                                <input type="text" style="width:120px;" value="" onkeypress="limpiaBusquedasXMedico('04',this,event);" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="apellidoPaterno" name="textfield3"/>
                            </div>
                        </div>
                        <div style="width: 100%; height: 30px; ">
                            ...
                            <div style=" float: left;" id="DivTextapeMat">
                                <input type="text" style="width:120px;" value="" onkeypress="limpiaBusquedasXMedico('04',this,event);" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="apellidoMaterno" name="textfield4"/>
                            </div>
                        </div>
                        <div style="width: 100%; height: 30px; ">
                            ...
                            <div style="float: left;" id="DivtextNombre">
                                <input type="text" style="width:120px;" value="" onkeypress="limpiaBusquedasXMedico('04',this,event);" onblur="if (this.value=='') this.value=this.defaultValue;" onfocus="if (this.value==this.defaultValue) this.value='';" class="textPatronNombreBusqueda" id="nombres" name="textfield5"/>
                            </div>
                        </div>
            ...
            <div id="divResultados" style="width:300px;  height:300px;float: left; ">
                <div id="divTablaResultadosMedico" style="width:300px;height: 280px; background:#E3EFFF; float:left;   padding: 0px; " >
