        ...
        <div style="width:100%" align="center">
            <div style="width: 100%;float:left;" align="center">
                <table width="100%" align="center">
                    ...
                    <tr align="center"><td colspan="2" nowrap="nowrap" scope="row" align="center"><a href="#" onclick="getBusquedaPersonalSalud(event,this);"><img alt="" src="../../../../fastmedical_front/imagen/btn/b_buscar_off.gif" /></a></td></tr>
                </table>
...
<!--<table width="37%" border="0" cellpadding="0px" cellspacing="0px" id="idTableBusMedico" style="width:98%;margin-left:1%;margin-right:1%;-moz-border-radius: 5px;">
  <tr>
    <td scope="row">Prof.<a name="calendario" href="#" style="display:inline;"><img src="../../../../fastmedical_front/imagen/icono/hos_especialidad.png" width="16" height="16" align="right" style="display:inline;" /></a></td>
  ...
  <tr>
    <td colspan="2" scope="row" align="center"><a href="#" onclick="listarCronograma();"><img src="../../../../fastmedical_front/imagen/btn/b_buscar_off.gif" /></a>     </tr>
</table>
-->