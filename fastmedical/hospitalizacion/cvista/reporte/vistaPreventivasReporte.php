...
<html>
    ...
    <table border="0"style="margin-left: 50px;">
        <tr>
            <td>
                <label class="labelReporteEs">Seleccione Fecha:</label>
            </td>
            <td>
                <div id="divContenedorCalendar"></div>
            </td>
    ...
    <br>
    <div id="contenedorDirectorioMamografia" style="margin-left:10px;border:1px solid green;width: 98%;height: 350px;">
