...
<html>
    ...
    <table border="0"style="margin-left: 50px;">
        <tr>
            <td>
                <label class="labelReporteEs">Feha Inicio:</label>
            </td>
            <td>
                <input class="txtInputFecha" size="15" type="text" name="txtFechaMesFin" id="txtFechaMesInicio" size="20" onclick="calendarioHtmlx('txtFechaMesInicio')" maxlength="10">
            </td>
            <td rowspan="2">
        ...
        <tr>
            <td>
                <label class="labelReporteEs"> Feha Fin:</label>
            </td>
            <td>
                <input class="txtInputFecha"  size="15" type="text" name="txtFechaMesFin" id="txtFechaMesFin" size="20" onclick="calendarioHtmlx('txtFechaMesFin')" maxlength="10">
            </td>
        </tr>
    </table>
    <br>
