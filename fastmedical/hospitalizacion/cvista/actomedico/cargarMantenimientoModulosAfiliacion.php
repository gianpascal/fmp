   ...
   <div style="width: 96%;height:5%;padding:2%;">
        <table style="border:0px solid;width: 60%;height: 100%;">
            <tr>
                ...
                <td>
                    <input id="txtBusquedaAfiliacion" type="text" style="background-color:#E9E9E9;border:1px solid #006631;font-size:24px;font-family: segoe UI;color:#006631;float:left;" onkeyup="filtrarAfiliacioanManteni(event)"/>
                    </td>   
                <td>
    ...
    <script>
        document.getElementById('txtBusquedaAfiliacion').focus();
    </script>
    <div style="border:0px solid;width: 40%;height:600px;float:left;padding:20px;">
        <div id="contenedorAFiliaciones"style="height:600px;border:1px solid">
            <?php   
            echo $o_ActionActoMedico->cargarTablaAfiliaciones($datos);
            ?>
        </div>
    </div>
