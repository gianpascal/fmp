<center>
    <table>
        <tr>
            <td>
                <div id="nombreServicio" style="width: 500px;height: 50px;border:0px solid;color:#006631;font-size:20px;font-family:verdana;text-aling:center;">
    ...
    <div style="padding-left:195px;">
       <input onClick="guardarModulosPorArea()"  type="button" style="font-size:10px;font-family: segoe UI;color:white;float:left;width: 100px;height: 30px;border:2px solid white;background-color:#1B843C" value="Guardar"  onmouseout='this.style.background="#1B843C";' onmouseover='this.style.background="#006631";' onClick="document.getElementById('txtBusquedaServicio').value='';document.getElementById('txtBusquedaServicio').focus();" >
    </div>
</center>
