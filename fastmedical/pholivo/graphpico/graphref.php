...
require("../../hospitalizacion/cvista/reportes/graphpico/grab_globals.lib.php");
...
if($bkg == "") $bkg="FFFFFF";
	...
	include('../../hospitalizacion/cvista/reportes/graphpico/libcolores.php');
	include('../../hospitalizacion/cvista/reportes/graphpico/libfunciones.php');
