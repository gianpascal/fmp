            ...
            <tr>
                <td height="20">
                    <div style="float:left">
                        ...
                        <a href="#" onclick="CargarVentana('buscador3','Usuarios','../busqueda/buscadorPersona.php?p1=buscarUsuarios&id_sistema=<?php echo $id_sistema?>','850','300',false,true,'',1,'',10,10,10,10);"><img src="../../../../medifacil_front/imagen/icono/kappfinder.png" alt="Buscar" title="Buscar" border="0"/></a>
                    </div>
