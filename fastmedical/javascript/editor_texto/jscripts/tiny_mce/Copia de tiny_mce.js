...
tinymce.html.Styles=function(d,f){
    ...
    for(g=0;g<j.length;g++){
        ...
        parse:function(s){
            var y={},q,o,x,r,v=d.url_converter;
            function p(C,F){
                var E,B,A,D;
                E=y[C+"-top"+F];
                if(!E){
        ...
        function t(A){
            ...
            if(s){
            s=s.replace(/\\[\"\';:_]/g,t).replace(/\"[^\"]+\"|\'[^\']+\'/g,function(A){
                return A.replace(/[;:]/g,t)
                });
            while(q=b.exec(s)){
                ...
                if(o&&x.length>0){
                    ...
                    x=x.replace(k,c);
                x=x.replace(h,function(B,A,E,D,F,C){
                    F=F||C;
                    if(F){
                        F=n(F);
                        return"'"+F.replace(/\'/g,"\\'")+"'"
...
(function(a){
    ...
    b.parse=function(r){
        var A=this,f,n=0,E,j,m=[],B,l,I,u,q,k,x,z,G,s,D,p,H,o,F,K,J,C,h,g,v,t=0,y=a.html.Entities.decode;
    ...
    if(E=f[7]){
        ...
        if(!z||(G=e.getElementRule(E))){
            ...
            if(z){
                ...
                p.replace(h,function(M,L,Q,P,O){
                    var R,N;
                    L=L.toLowerCase();
                    Q=L in k?L:y(Q||P||O||"");
                    if(z&&L.indexOf("data-")!==0){
                        R=H[L];
                        if(!R&&o){
                            N=o.length;
                            while(N--){
                ...
                if(R.validValues&&!(Q in R.validValues)){
                    return
                }
                }
                B.map[L]=Q;
...
(function(d){
    ...
    d.create("tinymce.dom.DOMUtils",{
        ...
        DOMUtils:function(n,l){
            ...
            k.settings=l=d.extend({
                keep_values:false,
                hex_colors:1
            },l);
            k.styles=new d.html.Styles({
...
(function(){
    ...
    if(!B&&y.length>1&&e.nodeType===9&&!u&&f.match.ID.test(y[0])&&!f.match.ID.test(y[y.length-1])){
        ...
        E=B?{
            expr:y.pop(),
            set:a(B)
            }:b.find(y.pop(),y.length===1&&(y[0]==="~"||y[0]==="+")&&e.parentNode?e.parentNode:e,u);
...
getRng:function(m){
    var g=this,h,j,l,k1=g.win.document;
    if(m&&g.tridentSel){
        return g.tridentSel.getRangeAt(0)
        }
        try{
        if(h=g.getSel()){
            j=h.rangeCount>0?h.getRangeAt(0):(h.createRange?h.createRange():k1.createRange())
            }
        }catch(f){}
if(c.isIE&&j.setStart&&k.selection.createRange().item){
    l=k1.selection.createRange().item(0);
    j=k1.createRange();
    j.setStartBefore(l);
    j.setEndAfter(l)
    }
    if(!j){
    j=k1.createRange?k1.createRange():k1.body.createTextRange()
    }
...
_fixIESelection:function(){
    var n=this.dom,m=n.doc,g=m.body,j,k;
    m.documentElement.unselectable=true;
    function l(o,r){
        var p=g.createTextRange();
        try{
            p.moveToPoint(o,r)
            }catch(q){
            p=null
        ...
        if(p.button){
            o=l(p.x,p.y);
            if(o){
                if(o.compareEndPoints("StartToStart",k)>0){
                    o.setEndPoint("StartToStart",k)
                    }else{
...
function f(){
    n.unbind(m,"mouseup",f);
    n.unbind(m,"mousemove",h);
    j=0
    }
    n.bind(m,"mousedown",function(o){
...
c.addNodeFilter("br",function(k,l){
    ...
    while(n--){
        ...
        if(p[q.parent.name]&&q===o.lastChild){
            q.remove();
            if(o.isEmpty(m)){
                o.empty().append(new a.html.Node("#text",3)).value="\u00a0"
                }
            }
    }
});
        ...
        function b(n,v){
            ...
            if(a.isIE6){
                ...
                if(p.host==s.hostname&&p.port==s.port&&(p.protocol+":")==s.protocol){
                    a.util.XHR.send({
                        url:a._addVer(p.getURI()),
                        success:function(y){
                            var t=r.create("script",{
...
renderNode:function(){
    ...
    l=c.add(g,"div",{
        id:"menu_"+j.id+"_co",
        "class":j.classPrefix+(k["class"]?" "+k["class"]:"")
        });
    j.element=new b("menu_"+j.id,{
        blocker:1,
        container:k.container
        });
    if(k.menu_line){
        c.add(l,"span",{
            "class":j.classPrefix+"Line"
            })
        }
        m=c.add(l,"table",{
        id:"menu_"+j.id+"_tbl",
...
_add:function(k,h){
    ...
    g=c.add(j,"span",{
        "class":"mceIcon"+(r.icon?" mce_"+r.icon:"")
        });
    if(r.icon_src){
        c.add(g,"img",{
            src:r.icon_src
...
if(H.document_base_url!=n.documentBaseURL){
    ...
    G.iframeHTML+='<meta http-equiv="X-UA-Compatible" content="IE=7" /><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />';
...
u.dom=new n.dom.DOMUtils(u.getDoc(),{
    keep_values:true,
...
u.forceBlocks=new n.ForceBlocks(u,{
    forced_root_block:y.forced_root_block
    });
...
_addEvents:function(){
    var C=this,u,D=C.settings,r=C.dom,y={
        mouseup:"onMouseUp",
...
C.onKeyDown.add(function(s,t){
    switch(t.keyCode){
        case 8:
            if(C.selection.getRng().item){
            s.dom.remove(C.selection.getRng().item(0));
            return k.cancel(t)
            }
        }
    })
...
mceInsertContent:function(A,z,y){
    var x,v;
    q.setContent(y.replace(/\{\$caret\}/g,'<br id="_mce_caret" />'));
    x=m.select("#_mce_caret")[0];
    if(x){
        v=m.createRng();
        v.setStartBefore(x);
        v.setEndBefore(x);
...
mceReplaceContent:function(y,x,v){
    q.setContent(v.replace(/\{\$selection\}/g,q.getContent({
        format:"text"
    })))
    },
...
if(n.isWebKit){
    function u(t){
        ...
        if(q.getSel().focusNode==x.previousSibling){
            q.select(v.insertAfter(v.doc.createTextNode("\u00a0"),x));
            q.collapse(d)
            }
            v.insertAfter(A,x);
        z=v.getPos(A).y;
...
(function(c){
    ...
    createDropMenu:function(f,o,h){
        ...
        o=e({
            "class":"mceDropDown",
            constrain:j.settings.constrain_menus
            },o);
...
o=e({
    title:o.title,
    "class":"mce_"+f,
    menu_class:k.getParam("skin")+"Skin",
    scope:o.scope,
    more_colors_title:k.getLang("more_colors")
    },o);
f=m.prefix+f;
...
(function(a){
    a.Formatter=function(U){
        var L={},N=a.each,c=U.dom,q=U.selection,t=a.dom.TreeWalker,J=new a.dom.RangeUtils(c),d=U.schema.isValidChild,F=c.isBlock,l=U.settings.forced_root_block,s=c.nodeIndex,E="\uFEFF",e=/^(src|href|style)$/,R=false,B=true,p,O={
            apply:[],
            remove:[]
        };
...
tinymce.onAddEditor.add(function(e,a){
    ...
    if(c.inline_styles){
        ...
        font:function(k,j){
            b(j,{
                backgroundColor:j.style.backgroundColor,
                color:j.color,
                fontFamily:j.face,
                fontSize:h[parseInt(j.size)-1]
                })
            },
        u:function(k,j){
            b(j,{
