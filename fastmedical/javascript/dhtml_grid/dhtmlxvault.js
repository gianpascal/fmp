...
*/
/*
  modifique la linea 71 JUAN CARLOS LUDEÑA MONTESINOS  -  montesinos2005ii@gmail.com
  *
  */
...

{
        ...
        cellList.innerHTML = "<div class='fileName'><div id='divFileName"+(currentId)+"' class='fileName'>" + fileName + "</div></div> ";
...
dhtmlXVaultObject.prototype.setFormField = function(name, value) {
    ...
    if (value === null){
        if (field)this.uploadForm.removeChild(field)
    }else {
        if (!field){
