...
function dhtmlXWindows(){
    if(window.dhtmlXContainer){
        ...
        this.findByText=function(a){
            var b=[],c;
            for(c in this.wins)this.wins[c].getText().search(a,"gi")>=0&&(b[b.length]=this.wins[c]);return b
            };
        ...
        this.getBottommostWindow=function(){
            ...
            for(b in this.wins)this.wins[b].zi<a.zi&&(a=this.wins[b]);return a.zi!=0?a:null
            };
        ...
        this.getTopmostWindow=function(a){
            ...
            for(c in this.wins)this.wins[c].zi>b.zi&&(a==!0&&!this._isWindowHidden(this.wins[c])&&(b=this.wins[c]),a!=!0&&(b=this.wins[c]));return b.zi!=0?b:null
            };
...
this.createWindow=function(a,b,g,d,f){
    ...
    e.dir="ltr";
    for(var h in this.wins)this.wins[h].zi+=this.zIndexStep,this.wins[h].style.zIndex=this.wins[h].zi;e.zi=this.zIndexStep;
    e.style.zIndex=e.zi;
    e.active=!1;
    e._isWindow=!0;
    e.isWindow=!0;
...
this._getTopZIndex=function(a){
    ...
    for(c in this.wins)if(a==!0){
        if(this.wins[c].zi>b)b=this.wins[c].zi
            }else if(this.wins[c].zi>b&&!this.wins[c]._isSticked)b=this.wins[c].zi;return b
    };
...
this._getActive=function(){
    var a=null,b;
    for(b in this.wins)this.wins[b].className=="dhtmlx_window_active"&&(a=this.wins[b]);return a
    };
...
this._addDefaultButtons=function(a){
    ...
    b.btns.close=l;
    b.btns.dock=k;
    for(var n in b.btns)b.btns[n].winId=b.idd,this._attachEventsOnButton(b.idd,n);b=d=f=j=e=h=i=l=k=null
    };
...
this._parkWindow=function(a,b){
    ...
    if(c._isParkedAllowed||b)if(!this.enableParkEffect||!c.parkBusy){
        if(c._isParked)this.enableParkEffect&&!b?(c.parkBusy=!0,this._doParkDown(c)):(c.h=c.lastParkH,this._engineRedrawWindowSize(c),this._engineDoOnWindowParkDown(c),c.updateNestedObjects(),c.btns.park.title=c.btns.park.titleIfNotParked,c._allowResizeGlobal==!0&&(this._enableButton(c,"minmax1"),this._enableButton(c,"minmax2")),c._isParked=!1,b||(c.checkEvent("onParkDown")?
            c.callEvent("onParkDown",[c]):this.callEvent("onParkDown",[c])));
        else if(this.enableParkEffect&&!b)if(c.lastParkH=String(c.h).search(/\%$/)==-1?c.h:c.offsetHeight,c._allowResizeGlobal==!0&&(this._disableButton(c,"minmax1"),this._disableButton(c,"minmax2")),this.enableParkEffect)c.parkBusy=!0,this._doParkUp(c);
            else{
            ...
            }else c.lastParkH=String(c.h).search(/\%$/)==
            -1?c.h:c.offsetHeight,c.h=this._engineGetWindowParkedHeight(c),this._engineRedrawWindowSize(c),this._engineDoOnWindowParkUp(c),c.btns.park.title=c.btns.park.titleIfParked,c._isParked=!0,b||(c.checkEvent("onParkUp")?c.callEvent("onParkUp",[c]):this.callEvent("onParkUp",[c]));
        c=null
        }
    };
...
this._closeWindow=function(a){
    ...
    for(d in this.wins)this.wins[d].zi>c.zi&&(c=this.wins[d]);c!=null&&this._makeActive(c)
    };
...
this._bringOnBottom=function(a){
    for(var b in this.wins)if(this.wins[b].zi<a.zi)this.wins[b].zi+=this.zIndexStep,this.wins[b].style.zIndex=this.wins[b].zi;a.zi=50;
    a.style.zIndex=a.zi;
...
this._isWindowOnBottom=function(a){
    var b=!0,c;
    for(c in this.wins)this.wins[c]!=a&&(b=b&&this.wins[c].zi>a.zi);return b
    };
...
this._setWindowModal=function(a,b){
    b==!0?(this._makeActive(a),this._bringOnTop(a),this.modalWin=a,a._isModal=!0,this.modalCoverI.style.zIndex=a.zi-2,this.modalCoverI.style.display="",this.modalCoverD.style.zIndex=a.zi-2,this.modalCoverD.style.display=""):(this.modalWin=null,a._isModal=
        !1,this.modalCoverI.style.zIndex=0,this.modalCoverI.style.display="none",this.modalCoverD.style.zIndex=0,this.modalCoverD.style.display="none")
    };
    
this._bringOnTopAnyStickedWindows=function(){
    var a=[],b;
    for(b in this.wins)this.wins[b]._isSticked&&(a[a.length]=this.wins[b]);for(var c=0;c<a.length;c++)this._bringOnTop(a[c]);
...
this._removeWindowGlobal=function(a){
    ...
    for(var d in b.btns)this._removeButtonGlobal(b,d);b.btns=
    null;
    b.detachAllEvents();
...
this._clearAll=function(){
    ...
    for(var a in this.wins)this._removeWindowGlobal(a);this.wins=null;
    ...
    this.vp=null;
    for(a in this.skinParams)delete this.skinParams[a];c=this.window=this.unload=this.setViewport=this.setSkin=
...
this._engineAllowWindowResize=function(d,c,f,a){
    if(c.getAttribute){
        ...
        !0?f<=b.lcw?"corner_up_left":f>=d.w-b.rcw?"corner_up_right":"border_top":c.getAttribute("winResB")!=null&&c.getAttribute("winResB")=="yes"?f<=b.lcw?"corner_left":f>=d.w-b.rcw?"corner_right":"border_bottom":null
        }
    };
        ...
        _patch:function(c){
            ...
            c.createWindow=function(c){
                ...
                for(var b in c)if(d[b])a[d[b]](c[b]);
                    else b.indexOf("on")==0&&a.attachEvent(b,c[b]);return a
                }
            },
    animation:"setEffect",
