	...
	************************************************************************************************************/		
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = '../../imagenes/tab_view/tab_right_inactive.gif';
		...
		img.src = '../../imagenes/tab_view/tab_right_active.gif';
	...
	function tabClick()
	{
		...
		p=idArray[idArray.length-1];
		switch(p)
		{
			case "0":
				cambiar_gasto_ingreso('G','1','tab_contenido1');
				break;
			case "1":
				tipomodpre=document.getElementById("tipo_modpre").value;
				if(tipomodpre=="003")
					cambiar_gasto_ingreso('G','2','tab_contenido1');
				else
					cambiar_gasto_ingreso('I','1','tab_contenido2');
				break;
		}
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = '../../imagenes/tab_view/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = '../../imagenes/tab_view/close.gif';
