...
dhtmlx.extend=function(a,b){
    for(var c in b)a[c]=b[c];b._init&&a._init();
    return a
    };
...
callEvent:function(a,b){
    ...
    if(c)for(var e=0;e<c.length;e++)if(c[e].apply(this,b||[])===!1)d=!1;this._map[a]&&!this._map[a].callEvent(a,b)&&(d=!1);
    return d
    },
...
find:function(a){
    for(i=0;i<this.length;i++)if(a==this[i])return i;return-1
    },
each:function(a,b){
...
dhtmlx.html={
    create:function(a,b,c){
        ...
        for(e in b)d.setAttribute(e,b[e]);if(b.style)d.style.cssText=b.style;
...
xpath:function(a,b){
    if(window.XPathResult){
        var c=a;
        if(a.nodeName.indexOf("document")==
            -1)a=a.ownerDocument;
    ...
    this.data.attachEvent("onBeforeFilter",dhtmlx.bind(function(a,c){
        if(this._settings.dataFeed){
            ...
            if(a||d){
                ...
                var f=[],h;
                for(h in d)f.push("dhx_filter["+h+"]="+encodeURIComponent(d[h]));this.load(e+(e.indexOf("?")<0?"?":"&")+f.join("&"),this._settings.datatype);
                return!1
                }
            }
    },this));
...
add:function(a,b){
    if(this._scheme){
        var a=a||{},c;
        for(c in this._scheme)a[c]=a[c]||this._scheme[c];this._scheme&&(this._scheme.$init?this._scheme.$update(a):this._scheme.$update&&this._scheme.$update(a))
        }
...
dhtmlXChart=function(a){
    ...
    for(var b in dhtmlx.chart)dhtmlx.extend(this,
        dhtmlx.chart[b]);a.preset&&this.definePreset(a);
...
preset_setter:function(a){
    ...
    if(typeof dhtmlx.presets.chart[a]=="object"){
        ...
        for(b in d)if(typeof d[b]=="object")if(!this.defaults[b]||
            typeof this.defaults[b]!="object")this.defaults[b]=dhtmlx.extend({},d[b]);else for(c in this.defaults[b]=dhtmlx.extend({},this.defaults[b]),d[b])this.defaults[b][c]=d[b][c];else this.defaults[b]=d[b];return a
        }
        return!1
    },
...
_drawXAxis:function(a,b,c,d,e,f){
    if(this._settings.xAxis){
        ...
        for(var l=0;l<b.length;l++){
            ...
            !0?j=h+e/2+l*e:(j=l==b.length-1?d.x:h+l*e,k=!!l);
            j=parseInt(j,10)-0.5;
