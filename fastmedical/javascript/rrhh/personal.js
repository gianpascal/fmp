    ...
    if($opc!=2 && document.getElementById('txtId').value==''){ //editar o eliminar
        ...
        if(window.confirm($cadena)){
            ...
            switch ($opc){
                ...
                case 2:{ //Limpiar los datos para agregar
