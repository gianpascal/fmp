...
class tablaDHTMLX {
    ...
    public function stringXml($arrayCabecera, $arrayFilas, $arrayTamano, $arrayTipo, $arrayAlineacion, $posicionId, $arrayhidden, $arraySorting='') {
        //print_r($arraySorting);
        ...
        if (empty($arrayhidden)) {
            foreach ($arrayCabecera as $ind => $valor) {
                if (empty($arraySorting)) {
                    $sorting = 'str';
                } else {
                    $sorting = $arraySorting[$ind];
                }

                $cuerpocabecera.="<column width='" . $arrayTamano[$ind] . "' align='" . $arrayAlineacion[$ind] . "' type='" . $arrayTipo[$ind] . "' sort='" . $sorting . "' color=''>" . $arrayCabecera[$ind] . "</column>";
            }
        } else {
            ...
            foreach ($arrayCabecera as $ind => $valor) {
                ...
                $cuerpocabecera.="<column width='" . $arrayTamano[$ind] . "' align='" . $arrayAlineacion[$ind] . "' hidden='" . $arrayhidden[$ind] . "' type='" . $arrayTipo[$ind] . "' sort='" . $sorting . "' color=''>" . $arrayCabecera[$ind] . "</column>";
            }
        }
...
//----------fin cabecera
        ...
        public function generaTablaFullComboCartetizacion($arrayCabecera, $arrayFilas, $arrayTamanio, $arrayTipo, $arrayCursor, $arrayHidden, $arrayAling, $arrayCombo, $arrayColor='') {
//        header("Content-type: text/xml");
        if ($arrayColor == "") {
            foreach ($arrayCabecera as $i => $value) {
                $arrayColor[$i] = "";
