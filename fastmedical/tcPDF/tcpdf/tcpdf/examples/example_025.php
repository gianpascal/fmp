...
// draw jpeg image
$pdf->Image('../images/odontograma.png', 5, 5, 200, 100, '', 'http://www.tcpdf.org', '', true, 72);
$pdf->Image('../images/1.PNG', 13, 15, 5, 5, '', '#', '', true, 72);
$pdf->Image('../images/2.PNG', 18, 13, 5, 5, '', '#', '', true, 72);
$pdf->Image('../images/2.PNG', 23, 13, 5, 5, '', '#', '', true, 72);
$pdf->Image('../images/2.PNG', 27, 13, 5, 5, '', '#', '', true, 72);
$pdf->Image('../images/1.PNG', 30, 15, 5, 5, '', '#', '', true, 72);
