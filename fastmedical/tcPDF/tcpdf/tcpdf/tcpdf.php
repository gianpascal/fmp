	...
	public function getPageSizeFromFormat($format) {
		...
		switch (strtoupper($format)) {
			...
			case 'FR_POT'              : {$pf = array(878.740, 1133.858); break;}
                        case 'TICKET_ORDEN'        : {$pf = array(212, 300); break;}
                        case 'TICKET_CARGO'        : {$pf = array(212.598, 258.425); break;}
                        case 'RECETA_MEDICA'        : {$pf = array(282.598, 268.425); break;}
                        case 'RECETA_MEDICA_ESTANDARIZADA' : {$pf = array(  595.276,  425.441); break;}
                        case 'BOLETA_DE_PAGO' : {$pf = array(  212.598,  425.196 ); break;}
